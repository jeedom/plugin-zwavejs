...
- Zur Version wechseln *11.15.1* de ZwaveJsUI (beta)
...
- Zur Version wechseln *11.6.1* de ZwaveJsUI (beta)

# 16/09/2025

- Zur Version wechseln *10.5.1* de ZwaveJsUI (stable)
- Zur Version wechseln *11.2.1* de ZwaveJsUI (beta)
