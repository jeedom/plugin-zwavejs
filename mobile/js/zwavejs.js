...
function initZwavejsZwavejs() {
  ...
  $bottompanel_actionInclude.append('<a class="ui-bottom-sheet-link ui-btn ui-btn-inline waves-effect waves-button incluAct" data-method="include" data-options="2"><i class="fas fa-unlock" style="color:blue"></i> {{Inclusion non sécurisée}}</a>')
